...
| **Tests** | `*.test.ts` | 37 tests across share math, distribution allocation, balance computation, nonce verification (replay/wrong-wallet/wrong-purpose/tampered-amount), basket-config validation, deposit-watcher classification. |
