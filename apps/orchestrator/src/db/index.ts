...
export function getDb(): ReturnType<typeof drizzle> {
  ...
  // Idempotent ensure for tables added outside the drizzle-kit migration cycle.
  // If the migration was generated by drizzle-kit later this is a no-op; the
  // CREATE IF NOT EXISTS just guarantees the table is present at boot.
  sqlite.exec(`
